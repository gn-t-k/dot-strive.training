...
const Page: FC = () => {
    ...
    switch (actionData.action) {
      ...
      case "delete": {
        if (actionData.success) {
          ...
          navigate(`/trainees/${loaderData.trainee.id}/trainings`);
        } else {
          toast({
  ...
  }, [actionData, loaderData.trainee.id, navigate, toast]);

  if (!loaderData.training) {
    return null;
  }
  const { training, registeredExercises } = loaderData;
